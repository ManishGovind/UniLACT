...
def save_to_lmdb(output_dir, input_dir):
    ...
    # print("total tasks", len(tasks) , len(start_end_ids))
...
if __name__ == '__main__':
    ...
    parser.add_argument("--input_dir", default='/data/vidlab_datasets/robotics/calvin_dataset/task_ABC_D', type=str)
    parser.add_argument("--output_dir", default='/data/vidlab_datasets/robotics/calvin_dataset/lmdb_datasets_rgb_depth_motion', type=str)
