...
def get_dataset_path(parent_dir, dataset_name):
    if dataset_name in ['robo_net', 'cmu_playing_with_food', 'bridge_dataset', 'droid','bridgev2']:
        version = '1.0.0'
...
if __name__ == "__main__":
    ...
    parser.add_argument('--input_path', type=str, default='/data/vidlab_datasets/robotics/')
    parser.add_argument('--output_path', type=str, default='/data/vidlab_datasets/robotics/video_datasets')
            ...
            for i, episode in bar:
                ...
                try:
                    ...
                    if (args.max_num_episodes>0) and (num_episodes>=args.max_num_episodes):
                        ...
                        print(f"⚠️ Skipping corrupted episode {i}: {e}")
                        corrupted_episodes[split].append({'episode': i, 'error': str(e)})
                        continue      
                except Exception as e:
                    print(e)
                    continue
